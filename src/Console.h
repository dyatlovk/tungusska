#ifndef TUNGUSSKA_CONSOLE_H
#define TUNGUSSKA_CONSOLE_H
...
struct ExampleAppConsole
{
    ...
    ExampleAppConsole()
    {
        ...
        Commands.push_back("tn_ShowCross");
        Commands.push_back("tn_ShowHealth");
        Commands.push_back("tn_Grid");
        Commands.push_back("tn_uidemo");
        Commands.push_back("r_wireframe");
    ...
    void parseCommand(char *command) {
        ...
        while (token != nullptr)
        {
            ...
            if(i == 1) {
                // arg2 = std::stoi(token);
                // mCVar.getVar<int>( arg2 );
                // g_cvars.find(arg1)->second = arg2;
            }
